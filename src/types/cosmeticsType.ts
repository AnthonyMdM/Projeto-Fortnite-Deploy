// ==============================
// Fortnite API Types - Atualizado
// Compatível com /v2/shop e /v2/cosmetics
// ==============================
...
export type ShopDataType = {
  groups: ShopGroup[]; // agrupados por layout.id
};
